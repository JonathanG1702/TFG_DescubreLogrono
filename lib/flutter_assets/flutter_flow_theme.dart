...
abstract class FlutterFlowTheme {
  ...
  late Color grisClaro;
  late Color grisClaro2;
  late Color verdeCustom;
  late Color rojoCustom;
  late Color grisCustom;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF87CEEB);
  late Color alternate = const Color(0xFF1E90FF);
  ...
  late Color grisClaro = const Color(0xCDFFFFFF);
  late Color grisClaro2 = const Color(0xFFADB6BF);
  late Color verdeCustom = const Color(0xFF42D744);
  late Color rojoCustom = const Color(0xFFFF0000);
  late Color grisCustom = const Color(0xFF575757);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF1E90FF);
  late Color alternate = const Color(0xFF87CEEB);
  ...
  late Color accent1 = const Color(0xFFFF69B4);
  late Color accent2 = const Color(0xFFFFA500);
  late Color accent3 = const Color(0xFF228B22);
